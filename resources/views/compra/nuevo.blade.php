...
​    <div id='content' class = "content" style='display:block'>
    ...
    <div class="card"></div>
        ...
        <form action="/compra/nueva/guardar" method="get">
            ...
            <input type="number" min="1" max="99999" class="form-control" id="txtGuiaSerieMC" name="guia_serie">

            <label for="text-input" class="form-control-label">Guia Número</label>
            <input type="number" min="1" max="99999" class="form-control" id="txtGuiaNumeroMC" name="guia_numero">
            </div>
            <div class="row form-group">
                <label for="text-input" class="form-control-label">Factura Serie</label>
                <input type="number" min="1" max="99999" class="form-control" id="txtFacturaSerieMC" name="factura_serie">
    
                <label for="text-input" class="form-control-label">Factura Número</label>
                <input type="number"  min="1" max="99999" class="form-control" id="txtFacturaNumeroMC" name="factura_numero">
            </div>
        
            <div class="row form-group">
                <label for="text-input" class="form-control-label">Sub. Total S/</label>
                <input type="number" min="1" max="99999" class="form-control" id="txtSubtotalMC" readonly>
    
                <label for="text-input" class="form-control-label">IGV S/</label>
                <input type="number" min="1" max="99999" class="form-control" id="txtIgvMC" readonly>
    
                <label for="text-input" class="form-control-label">TOTAL S/</label>
                <input type="number" min="1" max="99999" class="form-control" id="txtTotalMC" readonly>
            </div>
